...
import { categoryImage, categoryList, deleteCategories } from '../../../api/Api';
                                                ...
                                                {categoryData.length === 0 ? (
                                                    ...
                                                    categoryData.map((category) => (
                                                        <tr key={category.id}>
                                                            ...
                                                            <td><img src={`${categoryImage}${category.photo}`} className="img-fluid w-25" alt="Category" /></td>
                                                            <td>
                                                                <Link to={`/edit-category/${category.id}`}><i className="bi bi-pen bg-primary text-white fs-5 p-2 me-2"></i></Link>
