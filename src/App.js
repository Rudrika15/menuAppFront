  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Protected Routes */}
        <Route path="/add-new-staff" element={<PrivateRoute element={<AddStaff />} />} />
        <Route path="/view-staff" element={<PrivateRoute element={<ViewStaff />} />} />
        <Route path="/trash-staff" element={<PrivateRoute element={<TrashStaff />} />} />


        <Route path="/add-new-category" element={<PrivateRoute element={<AddCategory />} />} />
        <Route path="/view-category" element={<PrivateRoute element={<ViewCategory />} />} />
        <Route path="/edit-category/:categoryId" element={<PrivateRoute element={<EditCategory />} />} />
        <Route path="/trash-category" element={<PrivateRoute element={<TrashCategory />} />} />
        
        
        <Route path="/add-new-table" element={<PrivateRoute element={<AddTable />} />} />
        <Route path="/view-table" element={<PrivateRoute element={<ViewTable />} />} />
        <Route path="/Trash-table" element={<PrivateRoute element={<TrashTable />} />} />

        <Route path="/view-menu" element={<PrivateRoute element={<View />} />} />
      </Routes>
      <Footer />
    </Router>
  );
